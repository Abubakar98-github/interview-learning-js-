/* 34. Pizzas: Think of at least three kinds of your favorite
pizza. Store these pizza names in a array, and then use a for 
...
const favoritePizzas: string[] = ["Pepperoni", "Margherita", "BBQ Chicken", "Fajita"];
